    ...
    execute: function () {
      ...
      _export("BaseAnimationComponent", BaseAnimationComponent = (_dec = ccclass('BaseAnimationComponent'), _dec2 = property({
        ...
        updateColorEffects(dt) {
          let needUpdateColor = false; // 更新所有效果的计时器
        ...
        updateFrameEvents() {
          ...
          const currentProgress = this.getCurrentAnimationProgress(); // 遍历所有帧事件
        ...
        updateDisplayColorEffect() {
          // 默认为正常颜色
          let highestPriorityEffect = (_crd && ColorEffectType === void 0 ? (_reportPossibleCrUseOfColorEffectType({
            error: Error()
        ...
        addFrameEvent(progress, callback, eventId, once = true) {
          // 限制进度范围
        ...
        clearFrameEvents(resetProgress = true) {
        ...
        addAttackFrameEvent(progress = 0.5, callback, eventId = (_crd && FrameEventId === void 0 ? (_reportPossibleCrUseOfFrameEventId({
          error: Error()
        }), FrameEventId) : FrameEventId).ATTACK_DAMAGE, once = false) {
        ...
        addSoundFrameEvent(progress, callback, eventId = (_crd && FrameEventId === void 0 ? (_reportPossibleCrUseOfFrameEventId({
          error: Error()
