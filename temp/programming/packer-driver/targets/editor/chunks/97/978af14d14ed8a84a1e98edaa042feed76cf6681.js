    ...
    execute: function () {
      ...
      _export("EnemyBoss", EnemyBoss = (_dec = ccclass('EnemyBoss'), _dec2 = property(_crd && AutoHuntAIComponent === void 0 ? (_reportPossibleCrUseOfAutoHuntAIComponent({
        ...
        onPerformAttack(damageData) {
          ...
          if (target) {
            const healthComponent = target.getComponent(_crd && HealthComponent === void 0 ? (_reportPossibleCrUseOfHealthComponent({
              error: Error()
            ...
            const moveAnimation = target.getComponent(_crd && MovementComponent === void 0 ? (_reportPossibleCrUseOfMovementComponent({
              error: Error()
            ...
            const pos = manager.game.calculateSolderCount(this.node.getWorldPosition().add(new Vec3(0, 1, 0)), target.getWorldPosition().add(new Vec3(0, 1, 0)), [(_crd && PHY_GROUP === void 0 ? (_reportPossibleCrUseOfPHY_GROUP({
              error: Error()
        ...
        performSkill() {
          const enemies = manager.game.getRangeSolder(this.node.getWorldPosition(), 7);

          if (enemies.length > 0) {
            for (const enemy of enemies) {
              const healthComponent = enemy.node.getComponent(_crd && HealthComponent === void 0 ? (_reportPossibleCrUseOfHealthComponent({
                error: Error()
              }), HealthComponent) : HealthComponent);
              ...
              const moveAnimation = enemy.node.getComponent(_crd && MovementComponent === void 0 ? (_reportPossibleCrUseOfMovementComponent({
                error: Error()
              }), MovementComponent) : MovementComponent);
              ...
              const pos = manager.game.calculateSolderCount(this.node.getWorldPosition().add(new Vec3(0, 1, 0)), enemy.node.getWorldPosition().add(new Vec3(0, 1, 0)), [(_crd && PHY_GROUP === void 0 ? (_reportPossibleCrUseOfPHY_GROUP({
                error: Error()
              }), PHY_GROUP) : PHY_GROUP).SOLDER, (_crd && PHY_GROUP === void 0 ? (_reportPossibleCrUseOfPHY_GROUP({
                error: Error()
              }), PHY_GROUP) : PHY_GROUP).HERO]);
