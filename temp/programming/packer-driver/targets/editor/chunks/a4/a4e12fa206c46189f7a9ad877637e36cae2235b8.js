      ...
      _export("FlatbreadContainer", FlatbreadContainer = (_dec = ccclass('FlatbreadContainer'), _dec2 = property({
        ...
        doPickupOneFlatbread(pickupComponent) {
          if (this.unlimitedMode) {
            ...
            if (flatbreadItem) {
              const dropItemCom = flatbreadItem.getComponent(_crd && DropItemCom === void 0 ? (_reportPossibleCrUseOfDropItemCom({
                error: Error()
              ...
              const tempFlatbread = manager.pool.getNode((_crd && ObjectType === void 0 ? (_reportPossibleCrUseOfObjectType({
                error: Error()
              }), ObjectType) : ObjectType).DropItemFlatbread);

              if (tempFlatbread) {
                const dropItemCom = tempFlatbread.getComponent(_crd && DropItemCom === void 0 ? (_reportPossibleCrUseOfDropItemCom({
                  error: Error()
                }), DropItemCom) : DropItemCom);
        ...
        receive(fromPosition, onArrived) {
          const flatbread = manager.pool.getNode((_crd && ObjectType === void 0 ? (_reportPossibleCrUseOfObjectType({
            error: Error()
          }), ObjectType) : ObjectType).DropItemFlatbread);
