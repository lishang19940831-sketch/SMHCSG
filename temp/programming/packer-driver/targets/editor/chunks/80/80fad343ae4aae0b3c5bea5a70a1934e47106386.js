      ...
      _export("WoodContainer", WoodContainer = (_dec = ccclass('WoodContainer'), _dec2 = property({
        ...
        doPickupOneWood(pickupComponent) {
          if (this.unlimitedMode) {
            ...
            if (woodItem) {
              const dropItemCom = woodItem.getComponent(_crd && DropItemCom === void 0 ? (_reportPossibleCrUseOfDropItemCom({
                error: Error()
              ...
              const tempWood = manager.pool.getNode((_crd && ObjectType === void 0 ? (_reportPossibleCrUseOfObjectType({
                error: Error()
              }), ObjectType) : ObjectType).DropItemWood);

              if (tempWood) {
                const dropItemCom = tempWood.getComponent(_crd && DropItemCom === void 0 ? (_reportPossibleCrUseOfDropItemCom({
                  error: Error()
                }), DropItemCom) : DropItemCom);
        ...
        receive(fromPosition, onArrived) {
          const wood = manager.pool.getNode((_crd && ObjectType === void 0 ? (_reportPossibleCrUseOfObjectType({
            error: Error()
          }), ObjectType) : ObjectType).DropItemWood);
