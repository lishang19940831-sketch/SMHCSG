System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, ObjectType, WheatCrop, ResourceFieldManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, TreeFieldManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "20397LNbIFMC6i8egDyN+jr", "TreeFieldManager", undefined);
      ...
      _export("TreeFieldManager", TreeFieldManager = (_dec = ccclass('TreeFieldManager'), _dec2 = property({
        type: [Node],
        displayName: '扫描根节点列表',
        ...
        min: 0
      }), _dec(_class = (_class2 = class TreeFieldManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        onLoad() {
          this._scan(); // 不在 onLoad 里注册，父节点世界矩阵此时可能尚未刷新
        ...
        _collectFromNode(node) {
          if (node.name.includes(this.nameKeyword)) {
            let crop = node.getComponent(_crd && WheatCrop === void 0 ? (_reportPossibleCrUseOfWheatCrop({
              error: Error()
            }), WheatCrop) : WheatCrop);
            ...
            crop.shakeDuration = 0.4; // 不在此处调用 refreshWorldPos()，统一在 start() 里刷新
        ...
        _registerToCentral() {
          const mgr = (_crd && ResourceFieldManager === void 0 ? (_reportPossibleCrUseOfResourceFieldManager({
            error: Error()
...
//# sourceMappingURL=0e1bffbb4bc11ff1f651a83d8d59c057b98cd22f.js.map