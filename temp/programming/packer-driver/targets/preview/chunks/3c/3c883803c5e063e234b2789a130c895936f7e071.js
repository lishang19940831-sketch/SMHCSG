  ...
  return {
    ...
    execute: function () {
      ...
      _export("Elevator", Elevator = (_dec = ccclass('Elevator'), _dec2 = property({
        ...
        init() {
          // 保持原有的x和z坐标，只修改y坐标
          var rightPos = this.standBoardRight.getPosition();
          var leftPos = this.standBoardLeft.getPosition();
        ...
        move(params) {
          ...
          var totalTasks = (this.currentUpNode ? 1 : 0) + (this.currentDownNode ? 1 : 0);

          var onElevatorComplete = () => {
            completedCount++;
          ...
          if (this.currentUpNode) {
            var rightCurrentPos = this.standBoardRight.getPosition();
          ...
          if (this.currentDownNode) {
            var leftCurrentPos = this.standBoardLeft.getPosition();
