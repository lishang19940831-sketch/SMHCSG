  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", mk_adaptation_node = (_dec = property({
        ...
        _delayed_update_adaptation(time_ms_n_) {
          if (time_ms_n_ === void 0) {
            time_ms_n_ = 50;
          }
        ...
        _adaptive_show_all(design_size_, frame_size_) {
          ...
          var scale_v2 = v2(design_size_.width / frame_size_.width, design_size_.height / frame_size_.height);
        ...
        _fill_width(design_size_, frame_size_) {
          ...
          var scale_n = design_size_.width / frame_size_.width;
          var scale_v2 = v2(scale_n, scale_n);
        ...
        _fill_height(design_size_, frame_size_) {
          ...
          var scale_n = design_size_.height / frame_size_.height;
          var scale_v2 = v2(scale_n, scale_n);
        ...
        _event_global_resize() {
          // 防止部分手机旋转后未适配
          for (var k_n = 0, len_n = 6; k_n < len_n; ++k_n) {
