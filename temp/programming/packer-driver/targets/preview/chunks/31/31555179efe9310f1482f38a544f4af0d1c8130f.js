    ...
    execute: function () {
      ...
      _export("Ws", Ws = class Ws {
        ...
        connect(urlOrIp, port) {
          ...
          var url = port ? urlOrIp + ":" + port : urlOrIp;
        ...
        sendBuffer(cmd, buffer, key) {
          ...
          var message = new (_crd && Message === void 0 ? (_reportPossibleCrUseOfMessage({
            error: Error()
          }), Message) : Message)(cmd, buffer);
          var packedData = (_crd && WsCoder === void 0 ? (_reportPossibleCrUseOfWsCoder({
            error: Error()
