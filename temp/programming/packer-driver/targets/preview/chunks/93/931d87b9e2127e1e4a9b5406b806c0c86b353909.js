    ...
    execute: function () {
      ...
      _export("default", mk_adaptation_canvas = ccclass(_class = disallowMultiple(_class = class mk_adaptation_canvas extends Component {
        ...
        adaptation() {
          return _asyncToGenerator(function* () {
            ...
            var canvas = (_director$getScene2 = director.getScene()) == null ? void 0 : _director$getScene2.getComponentInChildren(Canvas); // 安检
            ...
            var frame_size = screen.windowSize;
            ...
            switch ((_crd && adaptation_config === void 0 ? (_reportPossibleCrUseOfadaptation_config({
              ...
              case (_crd && adaptation_config === void 0 ? (_reportPossibleCrUseOfadaptation_config({
                ...
                {
                  /** 设计尺寸 */
                  var design_size = (_crd && adaptation_config === void 0 ? (_reportPossibleCrUseOfadaptation_config({
                    error: Error()
                  ...
                  var higher_b = frame_size.height / frame_size.width > design_size.height / design_size.width;
      ...
      if (!EDITOR && (_crd && adaptation_config === void 0 ? (_reportPossibleCrUseOfadaptation_config({
        ...
        director.on(Director.EVENT_AFTER_SCENE_LAUNCH, () => {
          ...
          var canvas_node = (_director$getScene = director.getScene()) == null || (_director$getScene = _director$getScene.getComponentInChildren(Canvas)) == null ? void 0 : _director$getScene.node;
