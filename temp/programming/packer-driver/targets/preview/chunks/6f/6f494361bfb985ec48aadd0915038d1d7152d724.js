  ...
  return {
    ...
    execute: function () {
      ...
      (function (_adaptation_config) {
        ...
        (function (_view) {
          var adaptation_mode = /*#__PURE__*/function (adaptation_mode) {
          ...
          var adaptation_type = _view.adaptation_type = adaptation_mode.none;
          var original_design_size = _view.original_design_size = cc.size(960, 640);
