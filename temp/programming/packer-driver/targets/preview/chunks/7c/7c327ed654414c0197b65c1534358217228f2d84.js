    ...
    execute: function () {
      ...
      EventMgr = class EventMgr {
        ...
        on(key, callback, target) {
          ...
          var id = this.getOrCreateId(key, target);
          this.handlers[id] = {
            callback,
            target,
            key
          ...
          var sticky = this.stickyData[key];
        ...
        off(key, target) {
          var targetKeys = this.targetKeyMap.get(target);
        ...
        getOrCreateId(key, target) {
          var targetKeys = this.targetKeyMap.get(target) || {};
          var id = targetKeys[key] || ++this.uniqueId;
          targetKeys[key] = id;
