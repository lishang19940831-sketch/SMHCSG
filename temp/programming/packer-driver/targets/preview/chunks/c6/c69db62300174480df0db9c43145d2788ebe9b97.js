    ...
    execute: function () {
      ...
      LangMgr = class LangMgr {
        ...
        init() {
          ...
          var sysLang = this.getSystemLanguage();
        ...
        registerLanguageData(langCode, data) {
          ...
          this.langData[langCode] = _extends({}, this.langData[langCode], data);
        }
        /** 
         * 批量注册多种语言的数据
        ...
        getLanguage(key, def) {
          ...
          var text = (_this$langData$this$c = (_this$langData$this$c2 = this.langData[this.currLang]) == null ? void 0 : _this$langData$this$c2[key]) != null ? _this$langData$this$c : def;
          return text;
        }
