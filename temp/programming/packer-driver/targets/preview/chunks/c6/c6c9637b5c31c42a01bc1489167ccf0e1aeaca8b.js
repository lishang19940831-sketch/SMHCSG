    ...
    execute: function () {
      ...
      _export("TrainBoardingTrigger", TrainBoardingTrigger = (_dec = ccclass('TrainBoardingTrigger'), _dec2 = property({
        ...
        onLoad() {
          ...
          var collider = this.boardingTriggerNode.getComponent(Collider);
        ...
        update(_dt) {
          ...
          var trainHeadPos = this._trainManager.activeTrain.node.getWorldPosition();
        ...
        _onTriggerEnter(event) {
          ...
          this._fillTween = tween(this._fillObj).to(1.0, {
            ...
            var success = this._trainManager.tryBoardTrain();
