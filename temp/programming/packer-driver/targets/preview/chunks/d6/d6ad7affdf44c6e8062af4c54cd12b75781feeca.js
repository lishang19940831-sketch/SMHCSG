    ...
    execute: function () {
      ...
      _export("GlowController", GlowController = (_dec = ccclass('GlowController'), _dec2 = property({
        ...
        setGlowColor(color) {
          ...
          var colorVec4 = new Vec4(this.glowColor.r / 255, this.glowColor.g / 255, this.glowColor.b / 255, 1.0);
        ...
        setGlowImmediate(isGlow) {
          ...
          var targetIntensity = isGlow ? this.readyGlowIntensity : this.glowIntensity;
