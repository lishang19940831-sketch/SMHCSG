    ...
    execute: function () {
      ...
      _export("WinPanel", WinPanel = (_dec = ccclass('WinPanel'), _dec2 = property({
        ...
        showWinAni() {
          ...
          var winTitlePos = this.winTitle.position.clone();
          this.winTitle.position = new Vec3(winTitlePos.x, winTitlePos.y + 150, winTitlePos.z);
          var winTitleOpacity = this.winTitle.getComponent(UIOpacity) || this.winTitle.addComponent(UIOpacity);
        ...
        hideWinAni() {
          ...
          var winTitleOpacity = this.winTitle.getComponent(UIOpacity);
