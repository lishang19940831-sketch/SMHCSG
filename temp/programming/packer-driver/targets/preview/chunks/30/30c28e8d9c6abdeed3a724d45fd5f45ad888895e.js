  ...
  return {
    ...
    execute: function () {
      ...
      _export("JoystickControl", JoystickControl = (_dec = ccclass('JoystickControl'), _dec2 = property({
        ...
        onTouchStart(event) {
          var touchPos = event.getUIStartLocation();
        ...
        updateJoystickPosition(currentPos) {
          ...
          var distance = this._tempOffset.length(); // 应用死区
          ...
          var clampedDistance = Math.min(distance, this.stickLimit);

          var normalizedOffset = this._tempOffset.normalize();

          var stickX = normalizedOffset.x * clampedDistance;
          var stickY = normalizedOffset.y * clampedDistance;
