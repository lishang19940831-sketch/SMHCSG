System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, Crypt, _crd;

  _export("Crypt", void 0);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "94cdfyBmXdGMZq2YlwLE5iN", "Crypt", undefined);
       ...
       * 提供文本和二进制数据的加解密功能。
       */
      _export("Crypt", Crypt = class Crypt {
        // /**
        //  * 文本加密函数
        ...
        // }
        static strEncrypt(plainText, key) {
          return plainText;
        } // /**
        //  * 文本解密函数
        ...
        static strDecrypt(cipherText, key) {
          // const keyString = this.getKeyString(key);
          // const cipherTextBytes = CryptoES.enc.Base64.parse(cipherText);
          // const iv = CryptoES.lib.WordArray.create(cipherTextBytes.words.slice(0, 4), 16);
          // const encryptedText = CryptoES.lib.WordArray.create(cipherTextBytes.words.slice(4), cipherTextBytes.sigBytes - 16);
...
//# sourceMappingURL=8d879eb5cbdd614c2c6565311b6f3f7606ceea65.js.map