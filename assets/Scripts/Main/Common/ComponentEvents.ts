...
export enum ComponentEvent {
    ...
    ATTACK_COOLDOWN_END = 'component:attackCooldownEnd',
    ...
    // 电击震动相关事件
    ELECTRIC_SHOCK_START = 'component:electricShockStart',
    ELECTRIC_SHOCK_END = 'component:electricShockEnd',
    CHARACTER_ELECTRIC_SHOCK = 'component:characterElectricShock',
    
    // 角色控制事件
    CHARACTER_MOVE = 'component:characterMove',
    CHARACTER_MOVE_WORLD = 'component:characterMoveWorld',
    ...
    PICKUP_ITEM_FULL = 'component:updateItemFull',
    
    // 电量相关事件
    ELECTRIC_POWER_CHANGED = 'component:electricPowerChanged',
    SHOW_POWER_BAR = 'component:showPowerBar',

    // Layout事件
    ITEM_COUNT_CHANGED = 'component:itemCountChanged',

    // 物品组件事件
    PICKUP_ITEM_FINISH = 'component:pickupItemFinish',
} 