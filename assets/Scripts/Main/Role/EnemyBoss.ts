...
import { CharacterState, CommonEvent, EffectType, FrameEventId, ObjectType, PHY_GROUP } from '../../Main/Common/CommonEnum';
...
export class EnemyBoss extends Character {
   ...
   //console.log('敌人组件初始化完成，事件系统已准备就绪');
    ...
    protected onDead(): void {
        ...
        this.schedule(()=>{
            manager.drop.spawnParabolicItem(ObjectType.DropItemMeat, this.node.getWorldPosition());
        },0,20)
        this.scheduleOnce(() => {
