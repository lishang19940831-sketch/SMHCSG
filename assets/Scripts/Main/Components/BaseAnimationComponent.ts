...
import { ColorEffectType, FrameEventId } from '../../Main/Common/CommonEnum';
...
export abstract class BaseAnimationComponent extends BaseComponet {
    ...
    /** 电击效果颜色 (蓝色) */
    protected readonly electricShockColor: Color = new Color(90, 255, 255, 255);
    ...
    public set RunAttackAnimName(name: string) {
     ...
     * 播放移动动画
     */
    public abstract playMove(timeScale?: number): void;
     ...
     */
    public abstract playAnimationFromProgress?(name: string, loop: boolean, timeScale?: number, startProgress?: number): void;
     ...
     */
    public clearFrameEvents(resetProgress: boolean = true): void {
