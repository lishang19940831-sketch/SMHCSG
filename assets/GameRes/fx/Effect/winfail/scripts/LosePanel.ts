...
export class LosePanel extends Component {
    ...
    @property({type: Node, displayName: '重试按钮'})
    public retryBtn: Node = null!;
   ...
   //console.log('重试');
    ...
    public showLoseAni(): void {
        ...
        tween(this.retryBtn)
            .delay(0.3)
            .to(0.5, { position: retryBtnPos }, { easing: 'backOut' })
            .start();

        tween(retryBtnOpacity)
            .delay(0.3)
            .to(0.5, { opacity: 255 })
            .start();
    }
